...
const Index = () => {
  ...
  return (
    <div className="min-h-screen bg-background emotional-bg">
      ...
      {/* Hero Section */}
      <section className="pt-32 pb-20 px-4 educational-bg">
        <div className="container mx-auto max-w-5xl text-center study-mode">
          <div className="inline-flex items-center gap-2 bg-gradient-hero text-white px-6 py-3 rounded-full mb-6 shadow-empathy border-2 border-white/20">
            <Sparkles className="w-5 h-5" />
            <span className="font-semibold">AI for Inclusion, Empathy & Learning</span>
          </div>
          ...
          <p className="text-xl md:text-2xl text-muted-foreground mb-10 max-w-3xl mx-auto leading-relaxed">
            ...
            empowering people of all abilities to connect, express, learn, and thrive.
          </p>
      ...
      {/* Features Grid */}
      <section id="features" className="py-20 px-4 bg-muted/30 emotional-bg">
      ...
      <section className="py-20 px-4 bg-muted/20 educational-bg">
        <div className="container mx-auto max-w-6xl">
      ...
      {/* About Section */}
      <section id="about" className="py-20 px-4 bg-background emotional-bg study-mode">
      ...
      {/* CTA Section */}
      <section className="py-20 px-4 educational-bg">
        <div className="container mx-auto max-w-4xl">
          <Card className="bg-gradient-hero text-white border-2 border-white/20 shadow-empathy overflow-hidden relative">
